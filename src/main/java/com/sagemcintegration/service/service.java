    ...
    public boolean insertApibh(requestDTO invoiceDto,int cntitem,int batch) {
      try{
        ...
        Apibh apibh = Apibh.builder()
                ...
                .taxclass4((short) 0)
                .taxclass5((short) 0)
                .basetax1(invoiceDto.getTaxClass() == (short) 1 ? bigDecimalValue(invoiceDto.getCreditTaxableAmount()):BigDecimal.ZERO)
                ...
                .txbse1Hc(invoiceDto.getTaxClass() == (short) 1 ? bigDecimalValue(invoiceDto.getCreditTaxableAmount()):BigDecimal.ZERO)
       ...
       try {
           ...
           for (infoDTO dto : invoiceDto.getDebits()) {
               ...
               Apibd apibd = Apibd.builder()
                       ...
                       .swmanltx((short) 0)
                       .basetax1(invoiceDto.getTaxClass() == (short) 1 ? bigDecimalValue(dto.getAmount()):BigDecimal.ZERO)
                       .basetax2(BigDecimal.valueOf(0))
                       .basetax3(BigDecimal.valueOf(0))
                       .basetax4(BigDecimal.valueOf(0))
                       .basetax5(BigDecimal.valueOf(0))
                       ...
                       .id1099Clas("")
                       .amtdist(bigDecimalValue(dto.getAmount()))
                       ...
                       .txamtrt4Tc(BigDecimal.valueOf(0))
                       .txamtrt5Tc(BigDecimal.valueOf(0))
                       .txbse1Hc(invoiceDto.getTaxClass() == (short) 1 ? bigDecimalValue(dto.getAmount()):BigDecimal.ZERO)
                       .txbse2Hc(BigDecimal.valueOf(0))
                       .txbse3Hc(BigDecimal.valueOf(0))
                       .txbse4Hc(BigDecimal.valueOf(0))
                       .txbse5Hc(BigDecimal.valueOf(0))
